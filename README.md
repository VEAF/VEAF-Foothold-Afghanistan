...
The output is `VEAF_Foothold_Afghanistan_ICAO_OPPS_<date>.miz`.

> **The file name matters.** `_ICAO_OPPS` is read by the RealWeather extension of DCSServerBot,
> which fetches Peshawar's live METAR at mission start. Renaming the mission without that
